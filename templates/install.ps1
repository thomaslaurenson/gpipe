...
# Avoids emitting "name.exe.exe" when the binary name is already configured with
# a trailing .exe.
$script:InstallExeName = if ($script:Binary -like '*.exe') { $script:Binary } else { "$script:Binary.exe" }
...
function Resolve-InstallDir {
    ...
    $systemDir = "$env:ProgramFiles\$script:Binary"
...
function Install-Binary {
    ...
    Write-Ok "Installed $script:Binary to $InstallDir\$script:InstallExeName"
}
...
{{- end}}
        ...
        Write-Ok "Successfully installed $script:Binary $script:Version"
